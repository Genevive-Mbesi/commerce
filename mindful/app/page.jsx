...
const Home = () => {
  return (
      ...
      <section className='home relative w-full h-screen'> 
        ...
        <div className="grid flex-grow h-52 card bg-amber-500  rounded-box place-items-center">content</div> 
        </div>
        ...
        <div className="divider lg:divider-horizontal"></div> 
        <div className="grid flex-grow h-52 card bg-purple-950 rounded-box place-items-center">content</div> 
        </div>
        <div class="divider"></div> 
        <div className="flex justify-center flex-col p-8 items-center lg:flex-row">
